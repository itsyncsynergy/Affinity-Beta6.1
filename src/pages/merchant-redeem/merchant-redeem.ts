...
import { IonicPage, NavController, NavParams, LoadingController, AlertController, Platform, Events, ToastController, ModalController, Loading, List, ItemSliding, FabContainer, Refresher } from 'ionic-angular';
...
/**
 * Generated class for the MerchantRedeemPage page.
 *
...
@Component({
  ...
  selector: 'page-merchant-redeem',
  templateUrl: 'merchant-redeem.html',
})
export class MerchantRedeemPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController,
    ...
    //navParams.data
    console.log('here is the image ' + this.navParams.get('avatar'));
    this.data = {
      "avatar": this.navParams.get('avatar'),
      "headerImage": this.navParams.get('avatar'),
      "subtitle": 'Redeem from',
      "headerTitle": this.navParams.get('headerTitle'),
      "title": this.navParams.get('headerTitle'),
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MerchantRedeemPage');
  }
  ...
  ngOnInit() {
    ...
    this.getMerchantOffers(this.navParams.get('id'));
    this.transaction = {
      customer_id: window.localStorage.getItem('customer_id'),
  ...
  verifyUserValidity() {
    this.transaction.merchant_id = this.navParams.get('id');
