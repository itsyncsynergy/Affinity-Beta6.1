...
/**
 * Generated class for the LuxeMemberPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-luxe-member',
  templateUrl: 'luxe-member.html',
})
export class LuxeMemberPage {
  data:any;
  loading: Loading;
  base_url: any = ""
  user_image_link: any;
  ...
  pay(){
    ...
    if (membership == 'Luxe' && plans == 'Luxe_Monthly') {
        this.ticket = this.formBuilder.group({
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LuxeMemberPage');
  }
