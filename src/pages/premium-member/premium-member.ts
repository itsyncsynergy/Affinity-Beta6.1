...
/**
 * Generated class for the PremiumMemberPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-premium-member',
  templateUrl: 'premium-member.html',
})
export class PremiumMemberPage {
  data:any;
  loading: Loading;
  base_url: any = ""
  user_image_link: any;
  ...
  pay(){
    ...
    if (membership == 'Premium' && plans == 'Premium_Monthly') {
        this.ticket = this.formBuilder.group({
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PremiumMemberPage');
  }
