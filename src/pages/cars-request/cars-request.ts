...
/**
 * Generated class for the CarsRequestPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-cars-request',
  templateUrl: 'cars-request.html',
})
export class CarsRequestPage {
  data: any;
  loading: Loading;
  base_url: any = ""
  user_image_link: any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public modalCtrl: ModalController, public http: HttpClient, private alertCtrl: AlertController, private formBuilder: FormBuilder, public loadingCtrl: LoadingController, public storage: Storage) {
    ...
    this.cars = this.formBuilder.group({
  ...
  SendRequest(){
    ...
    this.data = this.http.post(url, this.cars.value);
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CarsRequestPage');
  }
