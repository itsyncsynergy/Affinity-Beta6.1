...
/**
 * Generated class for the AffinityLifeCategoriesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-affinity-life-categories',
  templateUrl: 'affinity-life-categories.html',
})
export class AffinityLifeCategoriesPage {
