  ...
  constructor(public af: AngularFireDatabase) {}
    ...
    getAllThemes = (): Array<any> => {
      return [
        ...
        {"title" : "QRCode", "theme"  : "qrcode",  "icon" : "ios-finger-print-outline", "listView" : false, "component":"", "singlePage":false},
    ...
    getDataForTheme = () => {
      return {
        ...
        "title": "Ionic 3 / Angular 6 UI Theme / Template App - Multipurpose Starter App - Orange Light"
      };
    };
